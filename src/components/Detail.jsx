...
export const Detail = () => {
  ...
  const fetchMovie = async () => {
    const data = await fetch(
      `https://api.themoviedb.org/3/movie/${id}?api_key=52927acc04425f286ec5e2d552230289&language=en-US`
    );
  ...
  const fetchCast = async () => {
    const castdata = await fetch(
      `https://api.themoviedb.org/3/movie/${id}/credits?api_key=52927acc04425f286ec5e2d552230289&language`
    );
  ...
  const fetchVideo = async () => {
    const data = await fetch(
      `https://api.themoviedb.org/3/movie/${id}/videos?api_key=52927acc04425f286ec5e2d552230289&language=en-US`
    );
